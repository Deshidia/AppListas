...
class AutofitRecyclerView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
    ...
    /** Lets a given adapter position span the full row width instead of a single cell,
     * eg. for a section-divider title placed in between grid items. */
    fun setSpanSizeLookup(getSpanSize: (position: Int) -> Int) {
